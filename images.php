...
if(isset($_POST['cart']))
	{
		$insert_sql="INSERT INTO `cart`(`item_no`, `quantity`, `user_id`) VALUES ('el_down','1','samhitha0811@gmail.com' where item_no=el_down)";
	}
//}
...
//		$cnt++;
		...
		<a href='.$field2name.' target="_blank">
          ...
          <center><span class="glyphicon glyphicon-heart-empty" style="color:#fff; font-size:30px;"></span></center>
                        ...
                        <button type="submit" name="cart" id="'.$c.'" onclick="GFG_click(this.id)" style="color:#fff;">Add to Cart</button>
