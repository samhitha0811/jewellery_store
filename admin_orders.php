...
<h1> JEWELLERY ORDERS </h1>

<?php 
include('db.php');
$query = "SELECT o.order_no,o.item_no,i.category,i.img,o.user_name,o.delivery_update FROM orders o inner join item i on o.item_no=i.item_no";


echo '<table> 
      <tr> 
          <th align="center"> <font face="Arial">Order Number</font> </th> 
		  <th align="center"> <font face="Arial">Item Number</font> </th> 
		  <th align="center"> <font face="Arial">Category</font> </th> 
          <th align="center"> <font face="Arial">Image</font> </th> 
          <th align="center"> <font face="Arial">User Name</font> </th> 
...
if ($result = mysqli_query($link,$query)) {
    while ($row = $result->fetch_assoc()) {
		...
		$field2name = $row["item_no"];
		$field3name = $row["category"];
        $field4name = $row["img"];
        $field5name = $row["user_name"]; 
		$field6name = $row["delivery_update"]; 

        echo '<tr> 
                  <td>'.$field1name.'</td> 
                  <td>'.$field2name.'</td> 
				  <td>'.$field3name.'</td> 
                  <td><img src='.$field4name.' style="width:400px;height:400px;"></td> 
                  <td>'.$field5name.'</td> 
				  <td>'.$field6name.'</td> 
