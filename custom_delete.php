...
if(isset($_POST['submit']))
{
	...
	$g_delete  = mysqli_query($link, "DELETE from customize where order_no='".$_POST['num']."'") or die(mysqli_error($link));
			$login_check = mysqli_query($link, "SELECT * from `customize` where order_no='".$_POST['num']."'") or die(mysqli_error($link));
...
<body>
  ...
  <div id="myDropdown" class="dropdown-content">
	...
	<div>
        <input type="text" placeholder="Enter order number" name="num"></div>
